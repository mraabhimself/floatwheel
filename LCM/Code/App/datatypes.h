...
typedef enum {
	...
	FLOAT_COMMAND_LCM_CHARGESTATE = 28,
...
typedef enum {
	...
	FOOTPAD_FLAG_LEFT,			// Left 5 LEDs blue, Right 5 LEDs off (adc1 > 2.5V, adc2 < 2.5V).
	FOOTPAD_FLAG_RIGHT,			// Left 5 LEDs off, Right 5 LEDs blue (adc1 < 2.5V, adc2 > 2.5V).
	FOOTPAD_FLAG_BOTH,			// All 10 LEDs blue (adc1 > 2.5V, adc2 > 2.5V).
	FOOTPAD_FLAG_NONE,			// All 10 LEDs off.
...
typedef enum {
	...
	LIGHT_PROFILE_1,		// Headlight bightness low, Lightpad brightness high, beep once
	LIGHT_PROFILE_2,		// Headlight bightness mid, Lightpad brightness mid, beep twice
	LIGHT_PROFILE_3,		// Headlight bightness high, Lightpad brightness low, beep thrice
} Light_Profiles;
